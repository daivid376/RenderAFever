...
def getRendererName(materialType):
    ...
    elif 'ai' in materialType or 'Arnold' in materialType:
        rendererName = 'arnold'
...
def materialConvert(sourceMaterialType,targetMaterialType,sourceColorSpace,targetColorSpace,affectColorSwitch,*args):
    sourceMaterialTypeReallyUsing = sourceMaterialType
    if '(' in sourceMaterialType:
        sourceMaterialTypeReallyUsing = sourceMaterialType.split('.')[0]

    targetMaterialTypeReallyUsing = targetMaterialType
    if '(' in targetMaterialType:
        targetMaterialTypeReallyUsing = targetMaterialType.spllit('.')[0]
    ...
    shadersConverting = [shader for shader in shadersConverting if mc.objectType(shader) == sourceMaterialTypeReallyUsing]
